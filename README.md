...
```
git clone https://github.com/Leocrydis/note-taker.git
```
...
## Preview:
![Application Preview](./public/assets/images/leocrydis-note-taker.herokuapp.com_.png)

## Deployed Link:
[Note Taker App](https://leocrydis-note-taker.herokuapp.com/)
...
## Authors
Isaiah Alvarez
* [GitHub](https://github.com/Leocrydis)
